...
# lasers
RED_LASER = pygame.image.load(os.path.join("fireball down.png"))
GREEN_LASER = pygame.image.load(os.path.join("fireball down.png"))
BLUE_LASER = pygame.image.load(os.path.join("fireball down.png"))
YELLOW_LASER = pygame.image.load(os.path.join("fireball.png"))
...
class Player(Ship):
    ...
    def healthbar(self ,window):
        pygame.draw.rect(window, (255 ,0 ,0), (self.x, self.y + self.ship_img.get_height() + 10 ,self.get_width(), 10))
        pygame.draw.rect(window, (0 ,255 ,0),
        (self.x, self.y + self.ship_img.get_height() + 10, self.get_width() * (self.health / self.max_health), 10))
...
def main():
    ...
    while run:
        ...
        if keys[pygame.K_w] and player.y - player_vel > 0:  # up
            player.y -= player_vel
        if keys[pygame.K_s] and player.y + player_vel + player.get_hight() + 15 < HEIGHT:  # down
            player.y += player_vel
