    ...
    while run:
        ...
        for event in pygame.event.get():
            ...
            if event.type == JOYHATMOTION:
                ...
                if event.value[0] == -1 and player.x - player_vel > 0:#Left
                    player.x -= player_vel
                    
                if event.value[0] == 1 and player.x + player_vel + player.get_width() < WIDTH:#right
                    player.x += player_vel
                    
                if event.value[-1] == 0 and player.y - player_vel > 0 :#up
                    player.y -= player_vel
                    
                if event.value[-0] == 1 and player.y + player_vel + player.get_hight() +15 < HEIGHT:#down
                    player.y += player_vel
