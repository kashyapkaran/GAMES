#url - https://youtu.be/5s-0rqykosE?t=251
import turtle
    ...
    def render(self, pen, sprites):
        ...
        for sprite in sprites:
            if sprite.state == "active":
                ...
                # make sure the sprites are close to the player
...
# Add enemy missiles
missiles.append(EnemyMissile(0, 100, "circles", "red"))
