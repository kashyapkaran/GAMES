#https://youtu.be/QFvqStqPCRU?t=5249
...
class SNAKE:
    ...
    def draw_snake(self):
        ...
        for index,block in enumerate(self.body):
            ...
            print("draw snake index: "+str(index))
...
while True:
    ...
    #main_game.snake.update_head_graphics()
